               ...
               <marquee behavior="" direction=""><p>LAB PENETRATION TESTING | POWERED BY TOMCAT SQUAD</p></marquee> 
                <li class="active">
                    ...
                    <ul class="collapse list-unstyled" id="xssSubmenu">
                        <li>
                            <a href="LAB - CROSS SITE SCRIPTING\REFLECTED XSS">Reflected XSS</a>
                        </li>
                        <li>
                            <a href="../../LAB - CROSS SITE SCRIPTING\STORED XSS">Stored XSS</a>
                        </li>
                    </ul>
                </li>
                <li>
                    ...
                    <ul class="collapse list-unstyled" id="fileInclusionSubmenu">
                        <li>
                            <a href="../../LAB - FILE INCLUSION\REMOTE FILE INCLUSION">Remote File Inclusion</a>
                        </li>
                        <li>
                ...
                <li>
                    ...
                    <ul class="collapse list-unstyled" id="sqlInjectionSubmenu">
                        <li>
                            <a href="../../LAB - SQL INJECTION\BLIND SQL INJECTION">Blind SQL Injection</a>
                        </li>
                        <li>
                            <a href="../../LAB - SQL INJECTION\BYPASS ADMIN LOGIN">Bypass Admin Login</a>
                        </li>
                    </ul>
                </li>
                <li>
                    ...
                    <ul class="collapse list-unstyled" id="tokenAuthenticationSubmenu">
                        <li>
                            <a href="../../LAB - TOKEN AUTHENTICATION\LAB - CSRF">Cross Site Request Forgery</a>
                        </li>
                        <li>
                            <a href="../../LAB - TOKEN AUTHENTICATION\LAB - NO REDIRECT">No Redirect</a>
                        </li>
                    </ul>
                </li>
                <li>
                    <a href="../../LAB - WEBSHELL">WebShell Backdoor</a>
                </li>
            </ul>
