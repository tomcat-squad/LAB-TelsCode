...
<div class="container">
    <div class="text-center">
        <h1>LAB - NO REDIRECT</h1>
        <form><span>Input URL: </span><input name="url" value="" type="text"><input value="GO" type="submit"></form>
    </div>
</div>
<?php	
}
...
<?php
		...
		echo "Check your URL<br>Only http or https protocols are allowed</center>"; 
	}
}
